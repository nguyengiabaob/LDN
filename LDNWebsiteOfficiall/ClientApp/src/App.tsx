...
import GeneratePage from "./components/GeneralPages/GeneratePage";
      ...
      <React.Suspense fallback={loading}>
        <Routes>
          <Route element={<Layout />}>
            ...
            {Menus &&
              Menus.length > 0 &&
              Menus.filter((x: any) => x.component != null).map((x: any) => {
            ...
            <Route
              path={`/news/:id`}
              element={<GeneratePage type="news" />}
            ></Route>
          ...
          <Route path="/LDN/admin/*" element={<Backend />}></Route>
