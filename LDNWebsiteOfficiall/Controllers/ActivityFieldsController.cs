...
namespace LDNWebsiteOfficiall.Controllers
{
    ...
    public class ActivityFieldsController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutActivityFields(int id, ActivityFields activityFields)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<ActivityFields>> PostActivityFields(ActivityFields activityFields)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteActivityFields(int id)
        {
            var activityFields = await _context.ActivityFields.FindAsync(id);
            if (activityFields == null)
            {
